...
public class CallingFunctionsFromOtherFiles {
    ...
    public static String weekday(int mm, int dd, int yyyy) {
        ...
        if (WeekdayCalculator.is_leap(yyyy) && (mm == 1 || mm == 2)) total--;
        String dayOfWeek = WeekdayCalculator.weekday_name(total%7);
       
        date = dayOfWeek + ", " + MonthName.month_name(mm) + " " + dd + ", " + yyyy;
