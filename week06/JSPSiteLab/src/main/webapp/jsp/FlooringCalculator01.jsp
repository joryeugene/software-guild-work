...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form method="post" action="${pageContext.request.contextPath}/apps/flooringcalculatorresults">
                <b>Width (ft): </b><input type="text" name="width" size="5"><br>
                <b>Length (ft): </b><input type="text" name="length" size="5"><br>
                <b>Material Cost Per Square Foot: </b><input type="text" name="materialCostPerSquareFt" size="5"><br>
                <br>
                <input type="submit">
            </form>
