        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/apps/factorizor">Factorizor</a></li>
            ...
            <p><b>Number: </b>${num.num}</p>
            <p><b># of Factors: </b>${num.numOfFactors}</p>
            <p><b>Factors: </b>${num.factors}</p>
