...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form method="post" action="${pageContext.request.contextPath}/apps/interestcalculatorresults">
                <b>Principal: </b><input type="text" name="principal"><br>
                <b>Interest Rate (ex. 5.5%): </b><input type="text" name="interestRate" size="5"><br>
                <b>Compound Periods per Year: </b><input type="text" name="compoundPeriod" size="5"> (Quarterly = 4, Monthly = 12)<br>
                <b>Num of Years: </b><input type="text" name="years" size="5"><br>
                <br>
                <input type="submit">
            </form>
